                  ...
                  {activeTasks.length > 0 && (
                    <div className="space-y-2.5">
                      ...
                      {activeTasks.map((task) => {
                        ...
                        return (
                          <div key={task.id} className="bg-[#111] border border-[#2a2a2a] rounded-2xl p-4">
                  ...
                  {completedTasks.length > 0 && (
                    <div className="space-y-2.5">
                      ...
                      {completedTasks.map((task) => (
                        <div key={task.id} className="bg-[#111] border border-[#2a2a2a] rounded-2xl p-4 opacity-50 flex items-center gap-3">
