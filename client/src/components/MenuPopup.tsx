...
export default function MenuPopup({ onClose, onOpenInvite }: MenuPopupProps) {
  ...
  /* Card fixed height = profile(80) + 7 items(44×7=308) + py-2(8) = 396 → 396px */
  const CARD_H = 396;
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ background: "#0a0a0a", border: "1px solid #1c1c1e", height: CARD_H }}
                ...
                {overlay === "legal" && (
                  <div className="px-4 py-4 space-y-2.5">
                    <LegalBlock icon={<Lock className="w-3.5 h-3.5 text-purple-400" />} title="Data We Collect">
                      <p>Only minimum data: Telegram user ID, username, and first name. Used for account identification and reward delivery only. We do not sell your data.</p>
                    </LegalBlock>
